...
class Input extends React.Component {
  ...
  render() {
    return (
      <input placeholder="Search for names " onChange={this.handleChange} />
    );
  }
}
class Result extends React.Component {
  render() {
    ...
    const result = this.props.result.replace(
      regex,
      ...
      <div className="results-container">
        <ul>
          {this.props.results.map((result, index) => (
            ...
            // <Result key={result} result={result} query={this.props.query} />
          ))}
        </ul>
      </div>
    );
